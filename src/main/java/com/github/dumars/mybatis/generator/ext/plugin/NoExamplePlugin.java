...
public class NoExamplePlugin extends PluginAdapter implements Plugin {
	...
	@Override
	public boolean clientGenerated(Interface paramInterface,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return true;
	}

	@Override
	public boolean clientCountByExampleMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	@Override
	public boolean clientDeleteByExampleMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	@Override
	public boolean clientDeleteByPrimaryKeyMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return true;
	}
	...
	@Override
	public boolean clientInsertMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	@Override
	public boolean clientInsertSelectiveMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	public boolean clientSelectByExampleWithBLOBsMethodGenerated(
			Method paramMethod, TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	@Override
	public boolean clientSelectByPrimaryKeyMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return true;
	}
	...
	@Override
	public boolean clientCountByExampleMethodGenerated(Method paramMethod,
			Interface paramInterface, IntrospectedTable paramIntrospectedTable) {
	...
	@Override
	public boolean clientSelectAllMethodGenerated(Method paramMethod,
			Interface paramInterface, IntrospectedTable paramIntrospectedTable) {
		return true;
	}
	...
	@Override
	public boolean clientSelectByExampleWithBLOBsMethodGenerated(
			Method paramMethod, Interface paramInterface,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	@Override
	public boolean modelFieldGenerated(Field paramField,
			TopLevelClass paramTopLevelClass,
	...
	@Override
	public boolean modelGetterMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedColumn paramIntrospectedColumn,
			IntrospectedTable paramIntrospectedTable,
			ModelClassType paramModelClassType) {
	...
	@Override
	public boolean modelSetterMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedColumn paramIntrospectedColumn,
			IntrospectedTable paramIntrospectedTable,
			ModelClassType paramModelClassType) {
	...
	@Override
	public boolean sqlMapGenerated(GeneratedXmlFile paramGeneratedXmlFile,
			IntrospectedTable paramIntrospectedTable) {
		return true;
	}

	@Override
	public boolean sqlMapDocumentGenerated(Document paramDocument,
			IntrospectedTable paramIntrospectedTable) {
		return true;
	}
	...
	public boolean sqlMapResultMapWithoutBLOBsElementGenerated(
			XmlElement paramXmlElement, IntrospectedTable paramIntrospectedTable) {
		return true;
	}
	...
	@Override
	public boolean sqlMapInsertElementGenerated(XmlElement paramXmlElement,
			IntrospectedTable paramIntrospectedTable) {
		return true;
	}
	...
	@Override
	public boolean providerGenerated(TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return true;
	}

	@Override
	public boolean providerApplyWhereMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	@Override
	public boolean providerCountByExampleMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	@Override
	public boolean providerDeleteByExampleMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
	...
	@Override
	public boolean providerInsertSelectiveMethodGenerated(Method paramMethod,
			TopLevelClass paramTopLevelClass,
			IntrospectedTable paramIntrospectedTable) {
		return false;
	}
